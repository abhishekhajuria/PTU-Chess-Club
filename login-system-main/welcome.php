...
<nav class="navbar navbar-light bg-light">
  ...
  <a href="logout.php" class="btn btn-primary"><i class="fa fa-lock-open"></i> Logout</a>
    ...
    <div class="container">
    <a href="https://www.youtube.com/channel/UCerL4wDA74l23JCWg" target="_blank"><img class="card-img-top" src="images/ptu_logo.gif" alt="Card image cap" style="width:750px; height:400px;"></a>
